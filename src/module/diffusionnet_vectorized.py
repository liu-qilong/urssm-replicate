...
from src.utils.geometry import to_basis, from_basis
...
class DiffusionNet_vectorized(nn.Module):
    def __init__(
            self,
            C_in, C_out, C_width=128,
            N_block=4, last_activation=None, outputs_at='vertices',
        ...
        super(DiffusionNet_vectorized, self).__init__()
